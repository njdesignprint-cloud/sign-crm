...
(function () {
  ...
  const TEXTS = {
    es: {
      ...
      btnLogin: "Entrar",
      btnRegister: "Aceptar invitación",
      btnReset: "Recuperar contraseña",
      authHelpText: "Las cuentas nuevas requieren una invitación del propietario.",
      authGuideTitle: "¿Primera vez en SignShop HQ?",
      authGuideCompany: "<strong>Miembro invitado:</strong> completa tus datos y selecciona <strong>Aceptar invitación</strong>.",
    ...
    en: {
      ...
      btnLogin: "Sign in",
      btnRegister: "Accept invitation",
      btnReset: "Reset password",
      authHelpText: "New accounts require an invitation from the owner.",
      authGuideTitle: "New to SignShop HQ?",
      authGuideCompany: "<strong>Invited team member:</strong> complete your details and select <strong>Accept invitation</strong>.",
  ...
  const VIEW_META = {
    ...
    en: {
      ...
      documentos: ["Accounting · Estimates & invoices", "Create, send and track sales documents from the accounting center."],
